...
async def join_channel(event):
    try:
        await sython(JoinChannelRequest("@N_JNN"))
    except BaseException:
        pass
...
async def _(event):
    ...
    joinu = await sython(JoinChannelRequest('Bethon2'))
...
async def _(event):
      await event.reply("""السـورس يعمـل | بيثون
╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍╍
...
async def _(event):
      await event.reply("""بيثون OWNER : @F_P_l"""
)
